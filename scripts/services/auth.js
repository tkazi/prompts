...
app.factory('Auth', function($rootScope, FURL, $firebaseAuth, $firebase, $location) {
    ...
    createProfile: function(uid, user) {
      var profile = {
        email: user.email,
        hat_icon: 'images/thinking_cap_cropped.png',
    ...
    signedIn: function() {
      // console.log("signedIn function", Auth.user);
	...
	auth.$onAuth(function(authData) {
		// console.log("authData services", authData);
    if(authData) {      
